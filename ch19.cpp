...
class my_vector{ long unsigned int sz; T* elem; int space;public: my_vector(): sz{0}, elem{nullptr}, space{0} {} explicit my_vector(int s): sz(s), elem{new T[s]} {
...
sz = arg.sz; return *this;
}
T* p = new T[arg.sz]; copy(arg.elem, arg.elem*arg.sz, p);
delete[] elem;
elem = p;
space = sz = arg.sz;
return *this;
